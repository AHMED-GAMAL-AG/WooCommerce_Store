 ...
 */
function wcp_online_summit_product_class($php_class_name, $product_type)
{
    if ($product_type == 'wcp_online_summit') {
        $php_class_name = 'WC_Online_Summit_Product';
    }
...
?>
    ...
    <div id='wcp_online_summit_options' class='panel woocommerce_options_panel'><?php
                                                                                ...
                                                                                woocommerce_wp_text_input(
                                                                                    array(
                                                                                        'id' => 'wpcp_online_summit_time_from',
                                                                                ...
                                                                                woocommerce_wp_text_input(
                                                                                    array(
                                                                                        'id' => 'wpcp_online_summit_time_zone',
